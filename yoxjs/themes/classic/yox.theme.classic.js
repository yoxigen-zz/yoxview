yox.themes.classic = function(data, options){
    ...
    this.config = {
        view: {
            ...
            events: {
                cacheStart: function(e, item){ console.log("cacheStart ", item); elements.loader.style.display = "inline"; },
                cacheEnd: function(e, item){ console.log("cacheEnd"); elements.loader.style.display = "none"; },
